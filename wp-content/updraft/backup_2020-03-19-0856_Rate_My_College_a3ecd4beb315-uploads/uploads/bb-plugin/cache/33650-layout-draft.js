...
var wpAjaxUrl = 'http://ratemycollege.downwithdaman.com/wp-admin/admin-ajax.php';var flBuilderUrl = 'http://ratemycollege.downwithdaman.com/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig = {
	...
	paths : {
		pluginUrl : 'http://ratemycollege.downwithdaman.com/wp-content/plugins/bb-plugin/',
		wpAjaxUrl : 'http://ratemycollege.downwithdaman.com/wp-admin/admin-ajax.php'
	},
	breakpoints : {
		small  : 768,
		medium : 992	},
...
jQuery(function($) {
	...
	$(function() {
		$( '.fl-node-5cad6d2c84b92 .fl-photo-img' )
